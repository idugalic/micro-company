...
public interface BlogPostRepository extends ReadOnlyPagingAndSortingRepository {
	...
	Page<BlogPost> findByCategoryAndDraftFalseAndPublishAtBefore(@Param("category") BlogPostCategory category, @Param("publishedBefore")  Date publishedBefore, Pageable pageRequest);
	...
	Page<BlogPost> findByDraftFalseAndAuthorIdAndPublishAtBeforeOrderByPublishAtDesc(@Param("authorId") String authorId, @Param("publishedBefore") Date publishedBefore, Pageable pageRequest);
